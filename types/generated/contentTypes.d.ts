...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    customer: Attribute.Relation<'plugin::users-permissions.user', 'oneToOne', 'api::customer.customer'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    companyOverview: Attribute.RichText;
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    vehicles: Attribute.Relation<'api::category.category', 'oneToMany', 'api::vehicle.vehicle'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiCustomerCustomer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user: Attribute.Relation<'api::customer.customer', 'oneToOne', 'plugin::users-permissions.user'>;
    addres: Attribute.Component<'vehicles-e-commerce.address'>;
    orders: Attribute.Relation<'api::customer.customer', 'oneToMany', 'api::order.order'>;
    reviews: Attribute.Relation<'api::customer.customer', 'oneToMany', 'api::review.review'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    hero: Attribute.Component<'ui-components.hero'>;
    featuredVehicles: Attribute.Relation<'api::home.home', 'oneToMany', 'api::vehicle.vehicle'>;
    latestNews: Attribute.RichText;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    vehicles: Attribute.Relation<'api::order.order', 'manyToMany', 'api::vehicle.vehicle'>;
    ...
    payments: Attribute.Component<'vehicles-e-commerce.payment-information', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiPrivacyPolicyPrivacyPolicy extends Schema.SingleType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::privacy-policy.privacy-policy', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::privacy-policy.privacy-policy', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
...
export interface ApiReviewReview extends Schema.CollectionType {
  ...
  attributes: {
    ...
    vehicle: Attribute.Relation<'api::review.review', 'manyToOne', 'api::vehicle.vehicle'>;
    customer: Attribute.Relation<'api::review.review', 'manyToOne', 'api::customer.customer'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiVehicleVehicle extends Schema.CollectionType {
  ...
  attributes: {
    makerBrand: Attribute.String;
    model: Attribute.String & Attribute.Required;
    year: Attribute.Integer & Attribute.Required;
    description: Attribute.RichText;
    price: Attribute.Decimal;
    mediaFiles: Attribute.Media;
    category: Attribute.Relation<'api::vehicle.vehicle', 'manyToOne', 'api::category.category'>;
    engineDetails: Attribute.Component<'vehicles-e-commerce.engines-specifications'>;
    safetyRating: Attribute.Integer;
    orders: Attribute.Relation<'api::vehicle.vehicle', 'manyToMany', 'api::order.order'>;
    reviews: Attribute.Relation<'api::vehicle.vehicle', 'oneToMany', 'api::review.review'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::vehicle.vehicle', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::vehicle.vehicle', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
...
export interface ApiWarrantyWarranty extends Schema.SingleType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::warranty.warranty', 'oneToOne', 'admin::user'> & Attribute.Private;
    updatedBy: Attribute.Relation<'api::warranty.warranty', 'oneToOne', 'admin::user'> & Attribute.Private;
  };
}
